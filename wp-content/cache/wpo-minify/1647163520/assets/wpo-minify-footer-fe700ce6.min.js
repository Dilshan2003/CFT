...
jQuery(document).ready(function(){jQuery("#map").simplegmaps({MapOptions:{zoom:8,scrollwheel:!1,}})});jQuery(document).ready(function(){var mapHeight=jQuery("#map").parent().parent().height();if(mapHeight>0){jQuery("#map").css('height',mapHeight+'px')}});
