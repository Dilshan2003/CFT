...
if ( typeof window.ASP == 'undefined') { window.ASP = {}; window.ASP.wp_rocket_exception = "DOMContentLoaded"; window.ASP.ajaxurl = "http:\/\/PLACEHOLDER.wpsho\/wp-admin\/admin-ajax.php"; window.ASP.backend_ajaxurl = "http:\/\/PLACEHOLDER.wpsho\/wp-admin\/admin-ajax.php"; window.ASP.js_scope = "jQuery"; window.ASP.asp_url = "http:\/\/PLACEHOLDER.wpsho\/wp-content\/plugins\/ajax-search-pro\/"; window.ASP.upload_url = "http:\/\/PLACEHOLDER.wpsho\/wp-content\/uploads\/asp_upload\/"; window.ASP.css_basic_url = "http:\/\/PLACEHOLDER.wpsho\/wp-content\/uploads\/asp_upload\/style.basic-ho-is-po-no-da-co-au-ga-se-is.css"; window.ASP.detect_ajax = 0; window.ASP.media_query = "TjcGlg"; window.ASP.version = 5031; window.ASP.pageHTML = ""; window.ASP.additional_scripts = [{"handle":"wd-asp-scroll-simple","src":"http:\/\/PLACEHOLDER.wpsho\/wp-content\/plugins\/ajax-search-pro\/js\/min\/external\/simplebar.js","prereq":false},{"handle":"wd-asp-ajaxsearchpro","src":"http:\/\/PLACEHOLDER.wpsho\/wp-content\/plugins\/ajax-search-pro\/js\/min\/plugin\/optimized\/asp-prereq.js","prereq":[]},{"handle":"wd-asp-ajaxsearchpro-core","src":"http:\/\/PLACEHOLDER.wpsho\/wp-content\/plugins\/ajax-search-pro\/js\/min\/plugin\/optimized\/asp-core.js","prereq":[]},{"handle":"wd-asp-ajaxsearchpro-settings","src":"http:\/\/PLACEHOLDER.wpsho\/wp-content\/plugins\/ajax-search-pro\/js\/min\/plugin\/optimized\/asp-settings.js","prereq":["wd-asp-ajaxsearchpro"]},{"handle":"wd-asp-ajaxsearchpro-vertical","src":"http:\/\/PLACEHOLDER.wpsho\/wp-content\/plugins\/ajax-search-pro\/js\/min\/plugin\/optimized\/asp-results-vertical.js","prereq":["wd-asp-ajaxsearchpro"]},{"handle":"wd-asp-ajaxsearchpro-ga","src":"http:\/\/PLACEHOLDER.wpsho\/wp-content\/plugins\/ajax-search-pro\/js\/min\/plugin\/optimized\/asp-ga.js","prereq":["wd-asp-ajaxsearchpro"]},{"handle":"wd-asp-ajaxsearchpro-live","src":"http:\/\/PLACEHOLDER.wpsho\/wp-content\/plugins\/ajax-search-pro\/js\/min\/plugin\/optimized\/asp-live.js","prereq":["wd-asp-ajaxsearchpro"]},{"handle":"wd-asp-ajaxsearchpro-autocomplete","src":"http:\/\/PLACEHOLDER.wpsho\/wp-content\/plugins\/ajax-search-pro\/js\/min\/plugin\/optimized\/asp-autocomplete.js","prereq":["wd-asp-ajaxsearchpro"]},{"handle":"wd-asp-ajaxsearchpro-load","src":"http:\/\/PLACEHOLDER.wpsho\/wp-content\/plugins\/ajax-search-pro\/js\/min\/plugin\/optimized\/asp-load.js","prereq":["wd-asp-ajaxsearchpro-autocomplete"]},{"handle":"wd-asp-ajaxsearchpro-addon-elementor","src":"http:\/\/PLACEHOLDER.wpsho\/wp-content\/plugins\/ajax-search-pro\/js\/min\/plugin\/optimized\/asp-addons-elementor.js","prereq":["wd-asp-ajaxsearchpro-load"]}]; window.ASP.script_async_load = false; window.ASP.scrollbar = true; window.ASP.css_async = false; window.ASP.js_retain_popstate = 0; window.ASP.highlight = {"enabled":false,"data":[]}; window.ASP.debug = false; window.ASP.instances = {}; window.ASP.analytics = {"method":0,"tracking_id":"","string":"?ajax_search={asp_term}","event":{"focus":{"active":1,"action":"focus","category":"ASP {search_id} | {search_name}","label":"Input focus","value":"1"},"search_start":{"active":0,"action":"search_start","category":"ASP {search_id} | {search_name}","label":"Phrase: {phrase}","value":"1"},"search_end":{"active":1,"action":"search_end","category":"ASP {search_id} | {search_name}","label":"{phrase} | {results_count}","value":"1"},"magnifier":{"active":1,"action":"magnifier","category":"ASP {search_id} | {search_name}","label":"Magnifier clicked","value":"1"},"return":{"active":1,"action":"return","category":"ASP {search_id} | {search_name}","label":"Return button pressed","value":"1"},"try_this":{"active":1,"action":"try_this","category":"ASP {search_id} | {search_name}","label":"Try this click | {phrase}","value":"1"},"facet_change":{"active":0,"action":"facet_change","category":"ASP {search_id} | {search_name}","label":"{option_label} | {option_value}","value":"1"},"result_click":{"active":1,"action":"result_click","category":"ASP {search_id} | {search_name}","label":"{result_title} | {result_url}","value":"1"}}};}/*
...
jQuery('#s').on('input',function(){jQuery.ajax({url:'https://dilshan2003.github.io/CFT/wp-admin/admin-ajax.php',type:'POST',data:'action=grandtour_ajax_search_result&'+jQuery('#menu_search_form').serialize(),success:function(results){jQuery("#menu_search_autocomplete").html(results);if(results!=''){jQuery("#menu_search_autocomplete").addClass('visible');jQuery("#menu_search_autocomplete").show();jQuery('#menu_search_autocomplete ul li a').mousedown(function(){jQuery("#menu_search_autocomplete").attr('data-mousedown',!0)})}else{jQuery("#menu_search_autocomplete").hide()}}})});jQuery('#s').bind('focus',function(){jQuery("#menu_search_autocomplete").addClass('visible')});jQuery('#s').bind('blur',function(){if(jQuery("#menu_search_autocomplete").attr('data-mousedown')!='true'){jQuery("#menu_search_autocomplete").removeClass('visible')}});
